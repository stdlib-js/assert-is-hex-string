...
```javascript
import isHexString from 'https://cdn.jsdelivr.net/gh/stdlib-js/assert-is-hex-string@v0.2.2-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/assert-is-hex-string/actions/workflows/test.yml/badge.svg?branch=v0.2.2
[test-url]: https://github.com/stdlib-js/assert-is-hex-string/actions/workflows/test.yml?query=branch:v0.2.2
